...
interface MessageProps {
  ...
  toBeDeletedMessages: string[];
  setToBeDeletedMessages: React.Dispatch<React.SetStateAction<string[]>>;
}
  ...
  return (
    <>
      ...
      <div className="flex items-center">
        {isCurrentUserMessage && openDeleteModal && (
          <Checkbox
            checked={toBeDeletedMessages.includes(message._id)}
            onCheckedChange={(checked) => {
              // this checked gives you your updated operations, which means
              // if you want it checked, you set it to true and add it to prev
              // if you want it unchecked, remove from prev.
              checked
                ? setToBeDeletedMessages((prev) => [...prev, message._id])
                : setToBeDeletedMessages((prev) => prev.filter((id) => id != message._id));
            }}
          />
        )}
        <div
        ...
        >
          ...
          >
              ...
              >
                ...
                >
                  <Button
                    ...
                    className="cursor-pointer p-4 text-danger rounded-lg w-auto inline-flex items-center bg-red-700 hover:bg-red-600"
                  >
            ...
            {typeof message.message === "string" ? (
              <p className="text-md px-2 pt-1 flex justify-start">
                {message.message}
              </p>
              ...
              {typeof message.message !== "string" ? (
                <div className="flex text-md font-semibold text-center ml-4 justify-between gap-12">
                  ...
                  message.message.file.url.includes(".jpeg") ? (
                    ...
                    <p className="truncate mr-6">
                      {message.message.file.original_filename + ".raw"}
                    </p>
                  )}
                </div>
              ) : null}
